...
import com.myket.IABLogger;
import com.myket.MyketIABPluginBase;
import com.myket.MyketIABProxyActivity;
import com.myket.util.IabHelper;
import com.myket.util.IabResult;
import com.myket.util.Inventory;
import com.myket.util.Purchase;
import com.myket.util.SkuDetails;
		...
		, IabHelper.OnConsumeMultiFinishedListener
{
	...
	public void purchaseProduct(final String sku, final String developerPayload)
	{
		...
		runSafelyOnUiThread(new Runnable()
		{
			public void run()
			{
				Intent proxyStarter = new Intent(getActivity(), MyketIABProxyActivity.class);
